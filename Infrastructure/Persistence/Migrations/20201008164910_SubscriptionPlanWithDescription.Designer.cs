...
namespace Wbc.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20201008164910_SubscriptionPlanWithDescription")]
    partial class SubscriptionPlanWithDescription
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.Agency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.AgencyDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("HSCodePoolId");

                    b.ToTable("AgencyDocuments");
                });

            modelBuilder.Entity("Wbc.Domain.Entities.AgencyHsCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.DocumentCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.ExtraDocumentValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("AgencyHsCodeId");

                    b.HasIndex("DocumentTypeId");

                    b.ToTable("ExtraDocumentValues");
                });
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.GuestUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.HSCodeDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.HSCodeRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.Section", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.Sector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.Segment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.Tariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("HSCodeTariffTaxId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.TariffBenchmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.UserHSCodePool", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ExportingCountryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.UserTariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.UserTariffExtraTax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("UserHSCodePoolId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("UserHSCodePoolId");

                    b.ToTable("UserTariffExtraTaxes");
                });
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.AgencyDocument", b =>
                {
                    b.HasOne("Wbc.Domain.Entities.Agency", "Agency")
                        .WithMany()
                        .HasForeignKey("AgencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wbc.Domain.Entities.DocumentType", "DocumentType")
                        .WithMany()
                        .HasForeignKey("DocumentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wbc.Domain.Entities.HSCodePool", "HSCodePool")
                        .WithMany()
                        .HasForeignKey("HSCodePoolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.ExtraDocumentValue", b =>
                {
                    b.HasOne("Wbc.Domain.Entities.AgencyHsCode", "AgencyHsCode")
                        .WithMany()
                        .HasForeignKey("AgencyHsCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.HSCodeDocument", b =>
                {
                    b.HasOne("Wbc.Domain.Entities.DocumentCategory", "DocumentCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.Segment", b =>
                {
                    b.HasOne("Wbc.Domain.Entities.Sector", "Sector")
                        .WithMany()
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.Tariff", b =>
                {
                    b.HasOne("Wbc.Domain.Entities.HSCodeTariffTax", "HSCodeTariffTax")
                        .WithMany()
                        .HasForeignKey("HSCodeTariffTaxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Wbc.Domain.Entities.UserTariffExtraTax", b =>
                {
                    b.HasOne("Wbc.Domain.Entities.UserHSCodePool", "UserHSCodePool")
                        .WithMany("userTariffExtraTaxes")
                        .HasForeignKey("UserHSCodePoolId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
