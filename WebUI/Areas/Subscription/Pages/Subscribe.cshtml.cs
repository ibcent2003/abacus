...
namespace Wbc.WebUI.Areas.Subscription.Pages
{
    ...
    public class SubscribeModel : PageModel
    {
        ...
        private readonly IStringLocalizer<SubscribeModel> _stringLocalizer;

        public SubscribeModel(IMediator mediator, IStringLocalizer<SubscribeModel> stringLocalizer)
        {
            _mediator = mediator;
        ...
        {
            var vm = await _mediator.Send(new GetSubscriberCommandQuery { Process = Process.ChamberSubscriptionProcess });
            SupportingDocumentDtos = vm.SupportingDocumentDtos;
            Command.ProcessCode = Process.ChamberSubscriptionProcess.GetAttributeStringValue();
